...
const About = () => {
  ...
  return (
    <>
        <Helmet>
            <title>Nosotros - Brusi Propiedades</title>
            <meta name='description' content='Brusi Propiedades es una inmobiliaria compuesta por los profesionales Jonathan Brusi y Gustavo Seneca. El objetivo es poder acompañar y trabajar junto a los clientes durante el proceso de la compra o venta de una propiedad para hacerlo de la manera más segura y en el menor tiempo posible.'></meta>
        </Helmet>
